...
to fill: its corpus was assembled from the two final Stage-2 artifacts and frozen, by digest, byte
count and ordered ids, in `src/lib/ai/evals/design-intent-challenge-v4-freeze.test.ts`. T20 authored the
