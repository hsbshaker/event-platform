...
const FORBIDDEN_PATHS = [
  ...
  "src/lib/renderer/planner/index.ts",
  "src/lib/renderer/planner/selector.ts",
  "src/lib/renderer/planner/directives.ts",
  "src/lib/renderer/vocabulary/index.ts",
  "src/lib/renderer/design-intent.ts",
  "src/lib/renderer/compile/page-system.ts",
  "src/lib/renderer/compile/palette.ts",
  "src/lib/renderer/compile/typography.ts",
  "src/lib/renderer/compile/motifs.ts",
  "src/lib/renderer/compile/spacing.ts",
  "src/lib/renderer/compile/spec.ts",
